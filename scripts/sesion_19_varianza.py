...
# chi_squared_test_variance(n, sigma_squared, sigma_squared_0, alternative, alpha)
muestra = [2.32, 4.26, 4.02, 4.44, 3.68, 2.72, 1.90, 1.21]
n = len(muestra)

sigma_squared = np.var(muestra,ddof=1)
sigma_squared_0 = 0.8**2
alternative = "greater"
alpha = 0.05
