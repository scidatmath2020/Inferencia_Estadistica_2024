# -*- coding: utf-8 -*-
"""
Created on Tue Dec 17 17:43:44 2024
...
def t_test(sample, mu0, alternative='two-sided', alpha=0.05):
    """
    Prueba de hipótesis para la media con desviación estándar desconocida (prueba t).
    ...
    s = np.std(sample, ddof=1)             # Desviación estándar muestral (ddof=1 para muestra)
...
t_stat, p_value, conclusion = t_test(sample, mu0, alternative, alpha)
