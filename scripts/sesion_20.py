...
big_gauss = stats.norm(scale=1, loc=5).rvs(size=1000, random_state=rng)
...
plt.hist(big_gauss, edgecolor='black',bins=50,color="red")
len(big_gauss)
plt.show()

plt.hist(densidades_mexico.Population_Density, edgecolor='black')
len(densidades_mexico.Population_Density)
plt.show()

plt.hist(mi_lognorm, edgecolor='black',bins=30)
plt.show()
...
pruebas_gauss, prueba_anderson = gaussian_test(small_gauss)
...
pruebas_gauss, prueba_anderson = gaussian_test(mi_lognorm)
...
print(pruebas_gauss)
print(prueba_anderson)

#%%

muestra1 = pd.read_csv(r"C:\Users\Usuario\Documents\scidata\24_inf_est\proyectos\muestra_1.csv")

plt.hist(muestra1.valor,edgecolor="blue",color="red",bins=100)
plt.show()


stats.probplot(muestra1.valor, dist="norm", plot=plt)
plt.title("Gráfico Q-Q")
plt.show()


pruebas_gauss, prueba_anderson = gaussian_test(muestra1.valor)
print(pruebas_gauss)
print(prueba_anderson)
...
mi_modelo.fit_transform(muestra1.valor)
resultado = mi_modelo.summary
mi_modelo.plot_summary()
plt.show()

muestra1["transformado"] = np.log(muestra1.valor)

plt.hist(muestra1.transformado,edgecolor="blue",color="red",bins=100)
plt.show()


stats.probplot(muestra1.transformado, dist="norm", plot=plt)
plt.title("Gráfico Q-Q")
plt.show()


pruebas_gauss, prueba_anderson = gaussian_test(muestra1.transformado)
print(pruebas_gauss)
print(prueba_anderson)
